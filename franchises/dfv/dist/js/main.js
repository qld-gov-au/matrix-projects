...
(function () {
  ...
  */
  ...
  function simulateClick(elem) {
    console.log('in simulateClick'); // Create our event (with options)
    ...
    console.log('in simulateClick'); // If cancelled, don't dispatch our event
  ...
  */
  ...
  checkForMouseEvent(); // Standard events
